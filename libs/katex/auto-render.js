...
var splitWithDelimiters = function splitWithDelimiters(text, delimiters) {
    ...
    for (var i = 0; i < delimiters.length; i++) {
        ...
        data = (0, _splitAtDelimiters2.default)(data, delimiter.left, delimiter.right, delimiter.display, delimiter.showLabel || false);
    }
    return data;
};
...
var renderMathInText = function renderMathInText(text, optionsCopy) {
    ...
    for (var i = 0; i < data.length; i++) {
	    ...
	    optionsCopy.showLabel = data[i].showLabel;
            try {
...
var defaultAutoRenderOptions = {
	delimiters: [{ left: "$$", right: "$$", display: true, showLabel: true }, { left: "\\[", right: "\\]", display: true, showLabel: false }, { left: "\\(", right: "\\)", display: false, showLabel: false}],
...
var splitAtDelimiters = function splitAtDelimiters(startData, leftDelim, rightDelim, display, showLabel) {
    var finalData = [];
